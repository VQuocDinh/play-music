...
const menuListEle = document.querySelectorAll(".menu-list a");
...
const muiscListEle = document.querySelector(".music-list");
const albumListEle = document.querySelector(".album");
const artistListEle = document.querySelector(".artist");
...
const handleEditTodo = (id) => {
  const idx = user.findIndex((val) => val.id == id);
  selectedTodo = user[idx];
  inputEle.value = selectedTodo.content;
};
//render user list
const inputUserNameEle = document.getElementById("name-user");
const inputUserEmailEle = document.getElementById("email");
const inputUserPasswordEle = document.getElementById("password");
const inputUserBirthdayEle = document.getElementById("birthday");
...
const clearClassActive = () => {
  menuListEle.forEach((val) => val.classList.remove("active"));
};
